  ...
  return (
    <section className="space-y-5">
        ...
        {plans.map((p) => (
          ...
          >
            ...
            <div className="mt-4 text-sm text-neutral-700">
              <span className="font-medium text-neutral-950">{p.storiesPerMonth}</span>{" "}
              stories / month
            </div>
            ...
            <div className="mt-3 text-xs text-neutral-600">
              Cancel or change plan anytime via the Stripe portal link in your welcome email.
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-700">
        <span className="font-medium text-neutral-950">Note:</span>{" "}
        If a customer submits short or vague feedback, a PDF is still generated based on what they provided and it counts
        toward your monthly story limit.
      </div>
    </section>
  );
}
